...
export default function Login() {
  ...
  return (
    <>
      <Grid container spacing={0} sx={LoginStyles.mainGrid} overflow="hidden">
                ...
                <Grid container spacing={0}>
                  ...
                  <Grid item md={12} xs={12} sx={LoginStyles.formGrid}>
                    <Grid container spacing={2}>
                      ...
                      <CustomCheckbox sx={LoginStyles.rememberCheck}  onClick={checkBoxChecked}/>
                        <Typography
                          variant="subtitle2"
                          sx={{ display: "inline" }}
                          gutterBottom
                      ...
                      <Link 
                          to="/forgotPassword"  
                          sx={LoginStyles.forgotPassBox}
                        >
                          Forgot password
                        </Link>
                      </Grid> 
                      <Grid item xs={12} sx={LoginStyles.btnLogin}>
                        <CustomButton type="submit" variant="contained" fullWidth sx={LoginStyles.Login_btn}>
                          Login
                        </CustomButton>
                      </Grid>
