  ...
  return (
    ...
    <Header/>
     <Container maxWidth="xl">
        <Divider className={viewMoreStyle.headerDivider} />
        <AliceCarousel
        items={sliderList}
      ...
      /> 
      <Divider className={viewMoreStyle.headerDivider} />
        <Grid container spacing={2} pt={5} sx={{paddingLeft:'20px', paddingBottom:'50px' }}>
      ...
      <Divider className={viewMoreStyle.headerDivider} />
        <Grid container spacing={2} columns={12} >
          ...
          housing in all budget categories. </Typography> 
        ...
        <Grid container spacing={2} pt={5} sx={{paddingLeft:'20px' }}>
          ...
          >
            <Grid item xs={2} sm={3} md={3}>
                <Card sx={{ maxWidth: 345 }}> 
                  <CardContent sx={viewMoreStyle.userExperianceSection}>
